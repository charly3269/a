                                ...
                                <td class="px-6 py-4 whitespace-nowrap table-cell-border">
                                 ...
                                 <td class="px-6 py-4 table-cell-border " style="min-width: 140px;">
                                    <?php if($_SESSION['role'] === 'admin'): ?>
                                        <div class="text-sm text-gray-700"><?php echo htmlspecialchars($task['notes']); ?></div>
                                    <?php else: ?>
                                        <textarea
                                            class="form-input w-full h-24 text-sm"
                                            placeholder="Agregar notas..."
                                            data-task-id="<?php echo $task['id']; ?>"><?php echo htmlspecialchars($task['notes']); ?></textarea>
                                   <?php endif; ?>
                                </td>
        ...
        <div class="image-modal-content">
            <img id="modalImage" src="" alt="Full Size Image">
                        ...
                        <tfoot>
                          ...
                          <td colspan="2" class="px-6 py-4 text-left whitespace-nowrap text-sm font-medium text-gray-900"> $<?php echo number_format($total, 2); ?>
                             </td>
                         </tr>
                     </tfoot>
                            </tr>
